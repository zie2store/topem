document.addEventListener('DOMContentLoaded', () => {
    ...
    const searchInput = document.getElementById('search-input'); // New search input reference
    ...
    const apiUrl = 'https://topembed.pw/api.php?format=json';
            ...
            function applyFilters() {
                ...
                let filteredMatches = allMatchesData.filter(match => {
                    ...
                    // Search logic
                    const matchText = `${match.team1} ${match.team2} ${match.league} ${match.sport} ${match.date} ${match.time}`.toLowerCase();
